...
BENCHMARKS = {
    ...
    "cljd/ffi/jit": {"exec": ["dart", "run", "cljd_ffi_nonleaf.dill"]},
    "cljd/ffi/jit/leaf": {"exec": ["dart", "run", "cljd_ffi_leaf.dill"]},
    "cljd/ffi/aot": {"exec": ["./cljd_ffi_nonleaf_hello"]},
    "cljd/ffi/aot/leaf": {"exec": ["./cljd_ffi_hello"]},
